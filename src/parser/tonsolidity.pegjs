...
Optional
  = OptionalToken "(" __  Identifier __ ")" {
      return {
        type: "Identifier",
        name: "optional",
        start: location().start.offset,
...
AbiHeaderToken    = "AbiHeader"    !IdentifierPart
...
OnBounceToken   = "onBounce"    !IdentifierPart
OnTickTockToken = "onTickTock"    !IdentifierPart
OnCodeUpgradeToken = "onCodeUpgrade"    !IdentifierPart
AfterSignatureCheckToken = "afterSignatureCheck"    !IdentifierPart
...
ExternalMsgToken = "externalMsg"       !IdentifierPart
...
IgnoreIntOverflowToken = "ignoreIntOverflow" !IdentifierPart
...
InternalMsgToken = "internalMsg"   !IdentifierPart
...
MsgValueToken   = "msgValue"   !IdentifierPart
...
VectorToken     = "vector"     !IdentifierPart
WeeksToken      = "weeks"      !IdentifierPart
NanoToken       = "nano"       !IdentifierPart
NanoTonToken    = "nanoton"    !IdentifierPart
NTonToken       = "nTon"       !IdentifierPart
TonToken        = "ton"       !IdentifierPart
BTonToken       = "Ton"       !IdentifierPart
MicroToken      = "micro"       !IdentifierPart
MicrotonToken   = "microton"       !IdentifierPart
MilliToken      = "milli"       !IdentifierPart
MillitonToken   = "milliton"       !IdentifierPart
KilotonToken    = "kiloton"       !IdentifierPart
KTonToken       = "kTon"       !IdentifierPart
MegatonToken    = "megaton"       !IdentifierPart
MTonToken       = "MTon"       !IdentifierPart
GigatonToken    = "gigaton"       !IdentifierPart
GTonToken       = "GTon"       !IdentifierPart
...
Type
  = literal:(Mapping / Optional / Vector / AddressPayable / Identifier) members:("." Identifier)* parts:(__"[" __ (Expression)? __ "]")*
  {
    return {
      type: "Type",
...
StateMutabilitySpecifier
  = token:(ConstantToken / StaticToken / PureToken / ViewToken / PayableToken) {
      return {
...
StateVariableSpecifiers
 = constant:(ConstantToken/StaticToken/ImmutableToken) __ visibility:(VisibilitySpecifier) __? override:(OverrideToken)? __ {
    return {
      ...
      isstatic: constant? (constant[0] === "static" ? true: false) : false,
      isoverride: override?  true: false
    }
   } 
   /
  constant:(ConstantToken/StaticToken/ImmutableToken) __? override:(OverrideToken)? __? visibility:(VisibilitySpecifier)? __ {
    return {
      visibility: visibility? visibility[0]: null,
      isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
      isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
   ...
   /
   override:(OverrideToken) __ constant:(ConstantToken/StaticToken/ImmutableToken) __? visibility:(VisibilitySpecifier)? __ {
    return {
      visibility: visibility? visibility[0]: null,
      isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
      isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
   ...
   override:(OverrideToken) __? visibility:(VisibilitySpecifier)? __? constant:(ConstantToken/StaticToken/ImmutableToken)? __ {
    return {
      visibility: visibility? visibility[0]: null,
      isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
      isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
   ...
   visibility:(VisibilitySpecifier) __ override:(OverrideToken) __? constant:(ConstantToken/StaticToken/ImmutableToken)? __ {
    return {
       visibility: visibility? visibility[0]: null,
      isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
      isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
   ...
   visibility:(VisibilitySpecifier) __? constant:(ConstantToken/StaticToken/ImmutableToken)? __? override:(OverrideToken)? __ {
    return {
      visibility: visibility? visibility[0]: null,
      isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
      isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
...
StateVariableDeclaration
  = type:Type __ specifiers:StateVariableSpecifiers? __ id:Identifier __ value:StateVariableValue? __ EOS  
  {
    return {
      ...
      is_static: specifiers? specifiers.isstatic : false,
...
PragmaStatement
  ...
  / PragmaToken __ AbiHeaderToken __ featureName:(Identifier / StringLiteral) EOS {
    return {
      type: "AbiHeaderPragmaStatement",
      feature: featureName,
      start: location().start.offset,
      end: location().end.offset
    }
  ...
  / PragmaToken __ MsgValueToken __ value:DecimalLiteral __ denomination:Denomination EOS {
    return {
      type: "MsgValuePragmaStatement",
      value: value,
      denomination: denomination,
      start: location().start.offset,
      end: location().end.offset
  ...
  / PragmaToken __ IgnoreIntOverflowToken EOS {
    return {
      type: "IgnoreIntOverflowPragmaStatement",
      start: location().start.offset,
      end: location().end.offset
    }
  }
...
OnBounceDeclaration
  = OnBounceToken __ fnname:FunctionName __ args:ModifierArgumentList? __ body:FunctionBody
    {
      return {
...
OnTickTockDeclaration
  = OnTickTockToken __ fnname:FunctionName __ args:ModifierArgumentList? __ body:FunctionBody
    {
      return {
        type: "OnTickTockDeclaration",
        modifiers: args,
        body: body,
        start: location().start.offset,
        end: location().end.offset
...
TvmBuilderDeclaration
  = TvmBuilderToken __ id:Identifier __ body:VariableDeclarationList? __
  {
    return {
      type: "TvmBuilderDeclaration",
      name: id.name,
      body: body != null ? body.declarations : null,
      start: location().start.offset,
      end: location().end.offset
